...
const DEFAULT_AUDIO_ENGINE = Object.freeze({
    ...
    frameSize: 960,
    jitterBufferMs: 80,
    minJitterBufferMs: 40,
    maxJitterBufferMs: 180,
    audioMode: 'original',
    originalAudio: true,
...
function buildRelayRegistration(input = {}) {
    ...
    return {
        ...
        jitterBufferMs: sanitizeNumber(input.jitterBufferMs, DEFAULT_AUDIO_ENGINE.jitterBufferMs, 20, 500),
        codec,
        preferredCodec,
        ...
        supportsOpus: input.supportsOpus !== false,
...
function buildRelayStatus(registration = {}) {
    ...
    return {
        ...
        jitterBufferMs: normalized.jitterBufferMs,
        minJitterBufferMs: DEFAULT_AUDIO_ENGINE.minJitterBufferMs,
        maxJitterBufferMs: DEFAULT_AUDIO_ENGINE.maxJitterBufferMs,
