...
echo "  - https://voicelinkapp.app"
echo "  - https://community.voicelinkapp.app"
echo "  - https://voicelink.dev"
echo ""
echo "Test with:"
echo "  curl -s https://voicelinkapp.app/api/servers"
echo "  curl -s https://community.voicelinkapp.app/api/servers"
echo "  curl -s https://voicelink.dev/api/servers"
