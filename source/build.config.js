...
const buildConfig = {
    ...
    development: {
        ...
        // Output directories
        buildDir: path.resolve(__dirname, '../build-temp/dev'),
        distDir: path.resolve(__dirname, '../build-temp/dist-dev'),
    ...
    production: {
        ...
        // Output directories
        buildDir: path.resolve(__dirname, '../build-temp/prod'),
        distDir: path.resolve(__dirname, '../releases'),
