//
//  VoiceLink_By_Devine_Creations.swift
//  VoiceLink By Devine Creations
//
//  Created by Dominique on 3/6/26.
//
...
@main
class VoiceLink_By_Devine_Creations: DDDiscoveryExtension {
